...
# Chapter   : 3 回帰
# Theme     : 3-3-3 Elastic Netによる住宅価格予測モデルの実装
# Created by: Owner
...
#   --- L1正則化とL2正則化を同時に行うElasticNetを試す
...
# インスタンス生成
# --- モデル1: 線形回帰モデル
# --- モデル2: ElasticNetモデル（l1_ratio引数でl1正則化の比率を決める）
model1 = LinearRegression()
model2 = ElasticNet(alpha=0.1, l1_ratio=0.6)
